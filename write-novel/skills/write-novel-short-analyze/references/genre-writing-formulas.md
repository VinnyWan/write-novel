...
> **配合**：优先使用当前 skill 内的通用技法 reference；write-novel-setup 部署后使用项目本地 agent reference bundle 中的写作技法、结构格式、题材风格模块副本。

## 用作拆文标尺时

本文件原本是写作侧 playbook，写法是「怎么写」。`write-novel-short-analyze` 在拆文时把它当
